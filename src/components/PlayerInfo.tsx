          ...
          >
            {isDraw ? (
              ...
              <div className={`font-display text-lg tracking-wider ${
                winner === 'X' ? 'rainbow-sweep' : 'rainbow-sweep'
              }`}>
                {winner} WINS!
              </div>
            )}
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <motion.span
              ...
              className={`font-display text-2xl font-bold ${
                currentPlayer === 'X' ? 'neon-text-cyan' : 'neon-text-magenta'
              }`}
            >
              {currentPlayer}
            </motion.span>
...
function PlayerCard({
  ...
  const borderClass = color === 'cyan' ? 'neon-border-cyan' : 'neon-border-magenta';
  const textClass = color === 'cyan' ? 'neon-text-cyan' : 'neon-text-magenta';
