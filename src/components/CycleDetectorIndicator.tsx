    ...
    <div className="glass-panel p-3">
      ...
      <AnimatePresence mode="wait">
        {cycleDetected ? (
          ...
          >
            <div className="neon-text-red font-display text-sm font-bold animate-pulse-neon tracking-wider">
              CYCLE FOUND!
            </div>
            <div className="text-xs neon-text-red opacity-70 mt-1">
              Collapse imminent...
            </div>
          </motion.div>
        ) : (
          <motion.div
            ...
            className="text-center"
          >
            <div className="neon-text-green font-display text-sm font-bold tracking-wider">
              NO CYCLE
            </div>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 text-center">
        <div>
          <div className="font-mono text-lg neon-text-violet font-bold">{collapseCount}</div>
          <div className="text-xs opacity-40">Collapses</div>
        </div>
        <div>
          <div className="font-mono text-lg neon-text-gold font-bold">{edges.length}</div>
          ...
          <div className="flex gap-1 justify-center">
            {cycleLengths.map((len, i) => (
              <div
                ...
                style={{
                  background: `rgba(187, 0, 255, ${0.2 + len * 0.1})`,
