    ...
    return (
      ...
      >
        ...
        <line x1={x + GATE_W / 2} y1={y1} x2={x + GATE_W / 2} y2={y2}
          stroke="#ff00aa" strokeWidth="1.5" opacity="0.6"
          filter="url(#gate-glow)" />
        {/* Control dot */}
        <circle cx={x + GATE_W / 2} cy={y1} r="4" fill="#ff00aa" />
        {/* Target cross */}
        <circle cx={x + GATE_W / 2} cy={y2} r="8" fill="none" stroke="#ff00aa" strokeWidth="1.5" />
        <line x1={x + GATE_W / 2 - 5} y1={y2} x2={x + GATE_W / 2 + 5} y2={y2} stroke="#ff00aa" strokeWidth="1.5" />
        <line x1={x + GATE_W / 2} y1={y2 - 5} x2={x + GATE_W / 2} y2={y2 + 5} stroke="#ff00aa" strokeWidth="1.5" />
      </motion.g>
    );
  }
