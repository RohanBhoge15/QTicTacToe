  ...
  return (
    <header className="relative z-10">
      ...
      <div className="text-center mb-2">
        <motion.h1
          className="neon-sign inline-block"
          style={{
            color: '#00f0ff',
  ...
  return (
    <motion.button
      ...
      className={`flex items-center gap-1 px-2.5 py-1.5 rounded-md text-xs font-display tracking-wider
        transition-all ${
          active
            ? 'neon-border-gold text-yellow-300 bg-yellow-900/10'
            : 'border border-gray-700/50 text-gray-400 hover:border-cyan-700/50 hover:text-cyan-300 hover:bg-cyan-900/10'
        }`}
